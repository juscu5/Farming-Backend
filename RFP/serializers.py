...
from SubmitForm.models import Farming_Solution_User,Farming_Solution_Client,Farming_Solution_Type,Farming_Solution_Sites,PH_Farming_Solution
...
class RFP_PH_Farming_Get_Serializer(serializers.ModelSerializer):
    user_ref = Farming_Solution_User_Serializer()
    client_ref = Farming_Solution_Client_Serializer()
    type_ref = Farming_Solution_Type_Serializer()
    sites_ref = Farming_Solution_Sites_Serializer()
    class Meta:
        model = PH_Farming_Solution
        fields = ('farming_ident',  'need', 'count',  'requested_date', 'target_date', 'critical_item',  
        'status', 'remarks',  'email_trail','requestor', 'client_ref', 'sites_ref',  'type_ref',  'user_ref')

class RFP_Farming_Solution_Put_Custom_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PH_Farming_Solution
        fields = ('farming_ident',  'need', 'count',  
        'requested_date', 'target_date', 'resolved_date', 'resolved_days',
        'critical_item',  "updated_dt_utc", 
        'status', 'remarks',  'email_trail','requestor', 'client_ref', 
        'sites_ref',  'type_ref',  'user_ref')

class RFP_Farming_Solution_delete_Custom_Serializer(serializers.ModelSerializer):
    class Meta:
        model = PH_Farming_Solution
        fields = 'farming_ident', 'is_active'