...
class Farming_Solution_Client_Serializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields =('client_id', 'client_name', 'project_name','owner')
...
class  Workload_Farming_Solution_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # fields = '__all__'
        fields = ("farming_ident",
                  "requested_date", "target_date", "resolved_date", "resolved_days",
                  "status", "comments_progress", "client_ref", "sites_ref",
                  "type_ref", "user_ref")
        # 'user_id','ccms_id','first_name','middle_name','last_name','ccms_uname','user_type'
        # 'client_id',"client_name", "project_name", "owner",
        # 'site_id', 'site_name', 
        # type_id', 'type_name'
...
class Workload_Farming_Solution_Custom_Serializer(serializers.ModelSerializer):
    type_ref = serializers.IntegerField(source='type_ref_id')
    sites_ref = serializers.IntegerField(source='sites_ref_id')
    client_ref = serializers.IntegerField(source='client_ref_id')
    user_ref = serializers.IntegerField(source='user_ref_id')
    class Meta:
        ...
        # "client_name","project_name","owner"
        # ,"requested_date","target_date","resolved_date","resolved_days"
        # ,"status","comments_progress"
        ...
        # "created_dt_utc", "updated_dt_utc", "is_active",
        # "client_ref", "sites_ref", "type_ref",  "user_ref")
